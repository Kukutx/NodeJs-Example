...
//导入http模块,搭建服务器
//导入url,querystring 模块
const url = require('url');
const querystring = require('querystring');

///数据库部分
require('./model/index.js');	//导入数据库的js
const User = require('./model/user');	//导入集合规则的js
...
app.on('request', async (req, res) => {
	...
	if (method == 'GET') {
		...
		if (pathname == '/list') {
				...
				<body>
					<div class="container">
						...
						<form method="post" action="/add">
						  ...
						  <div class="form-group">
						    <label>专业</label>
						    <input name="major" type="major" class="form-control" placeholder="请输入专业">
						  </div>
						  <div class="form-group">
						    <label>请选择爱好</label>
						    <div>
						    	...
						    	<label class="checkbox-inline">
						    	  <input type="checkbox" value="写代码" name="hobbies"> 写代码
						    	</label>
						    	<label class="checkbox-inline">
						    	  <input type="checkbox" value="玩游戏" name="hobbies"> 玩游戏
						    	</label>
						    	<label class="checkbox-inline">
						    	  <input type="checkbox" value="看书" name="hobbies"> 看书
						    	</label>
						    	<label class="checkbox-inline">
			...
			let user = await User.findOne({_id: query.id});	//先查找该用户
			let hobbies = ['唱歌', '跳舞', 'rap', '打篮球', '写代码', '玩游戏', '看书','旅游']
			console.log(user)
			// 呈现修改用户表单页面
			let modify = `
				<!DOCTYPE html>
					...
					<div class="container">
						...
						<form method="post" action="/modify?id=${user._id}">
						  ...
						  <div class="form-group">
						   ...
						   <div class="form-group">
						    <label>专业</label>
						    <input value="${user.major}" name="major" type="major" class="form-control" placeholder="请输入专业">
						  </div>
						  <div class="form-group">
						    <label>请选择爱好</label>
						    <div>
